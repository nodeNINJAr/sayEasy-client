...
const Footer = () => {
  return (
    <footer className="pt-6 sm:pt-14 dark:bg-gray-800 bg-gray-200 dark:text-gray-50 text-gray-900">
        ...
        <div className="grid grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400 bg-violet-600">
                <svg
                  ...
                  viewBox="0 0 32 32"
                  fill="currentColor"
                  className="flex-shrink-0 w-5 h-5 rounded-full dark:text-gray-900 text-gray-50"
                >
                  <path d="M18.266 26.068l7.839-7.854 4.469 4.479c1.859 1.859 1.859 4.875 0 6.734l-1.104 1.104c-1.859 1.865-4.875 1.865-6.734 0zM30.563 2.531l-1.109-1.104c-1.859-1.859-4.875-1.859-6.734 0l-6.719 6.734-6.734-6.734c-1.859-1.859-4.875-1.859-6.734 0l-1.104 1.104c-1.859 1.859-1.859 4.875 0 6.734l6.734 6.734-6.734 6.734c-1.859 1.859-1.859 4.875 0 6.734l1.104 1.104c1.859 1.859 4.875 1.859 6.734 0l21.307-21.307c1.859-1.859 1.859-4.875 0-6.734z"></path>
                </svg>
              </div>
               <a className="text-4xl sm:text-5xl font-semibold font-figtree" href="/">Say<span className="text-[#9A59C9] ">Easy</span></a>
            </a>
            <p className="text-sm font-figtree font-medium text-gray-600 dark:text-gray-200 leading-6">
              ...
              <br /> and achieve fluency with ease and confidence, wherever your
              journey takes you!
            </p>
            <div className="flex justify-start pt-4 space-x-4 lg:pt-0 lg:col-end-13 text-2xl mt-4">
              <a
                rel="noopener noreferrer"
                href="#"
                title="Email"
                className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-600 bg-gray-300 text-gray-800 dark:text-gray-50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
            ...
            <ul>
              <li>
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className=" dark:hover:text-violet-400 hover:text-violet-600"
                >
                  Online Tutors
                </a>
              </li>
              <li>
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="dark:hover:text-violet-400 hover:text-violet-6000"
                >
                  Free Tutors
                </a>
              </li>
      ...
      {/* copywrite footer */}
      <div className="mt-5 text-center py-6 border-t border-gray-300 dark:border-gray-700">
          <div className="py-[10px] text-center text-gray-700 dark:text-gray-400 text-lg">
