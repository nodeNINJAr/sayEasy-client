...
const ProductSearch = ({ totalTutors, handleSearch,handleSort}) => {
  return (
    <div className="p-6 mx-auto mb-6 md:mb-10">
      {/* Header with Search */}
      <div className="flex flex-wrap sm:flex-nowrap justify-between items-center mb-4 gap-4">
        <div className="w-full sm:w-4/6 flex justify-between truncate gap-4">
