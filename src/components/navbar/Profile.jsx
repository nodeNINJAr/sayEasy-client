  ...
  return (
    <div className="relative">
      ...
      <div className="relative h-12 w-12 group">
        ...
        {/* Hidden Profile Card */}
        <div className="absolute top-14 -left-16  w-64 bg-white shadow-lg rounded-lg p-4 opacity-0 scale-95 transform transition-all duration-300 group-hover:opacity-100 group-hover:scale-100 z-10 pointer-events-none group-hover:pointer-events-auto">
          {/* Profile Info */}
