...
const SignUp = () => {
  ...
  const handleSignUp = (e) => {
    ...
    signUpUsingEmailPass(userEmail, password)
      .then(() => {
        toast.success(
          "🎉 Congratulations! Your account has been successfully created. You can now log in and start exploring. Welcome aboard!"
        );
      ...
      .catch((err) => {
        toast.error(
          "❌ Signup failed! Please ensure all required fields are filled out correctly and try again."
        );
  ...
  return (
    <div className="py-10 md:py-20">
        <Helmet>
        <title>Register || sayEasy</title>
      </Helmet>
      <div className="py-16 w-full mx-auto max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
        <h2 className="mb-3 text-3xl font-semibold text-center capitalize">
